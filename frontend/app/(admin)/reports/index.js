...
export default function OverstayScreen({ navigation }) {
  ...
  return (
    <View collapsable={false} style={[styles.container, { paddingTop: insets.top }]}><View style={{flex: 1}}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Overstays</Text>
        <TouchableOpacity onPress={() => router.push('/(admin)/reports/incident')}>
